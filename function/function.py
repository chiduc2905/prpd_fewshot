...
def plot_tsne(features, labels, num_classes=3, save_path=None):
    ...
    # If len(features) is small, adjust perplexity.
    ...
    # Determine unique classes present in labels to avoid palette errors if some classes are missing
    unique_labels = np.unique(labels)
    # Ensure palette maps correctly if we want consistent colors for classes 0, 1, 2...
